    ...
    <div style={{ fontFamily: 'Georgia, serif', background: '#0a0a0a', color: '#fff', minHeight: '100vh' }}>
      ...
      <section id="about" style={{ padding: '120px 48px', maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }}>
        <div style={{ position: 'relative' }}>
          ...
          <img src="/studio-6.jpg" alt="Studio" style={{ position: 'absolute', bottom: -40, right: -40, width: '45%', borderRadius: 12, objectFit: 'cover', height: 200, border: '4px solid #0a0a0a', filter: 'brightness(0.85)' }} />
        </div>
      ...
      <section id="gallery" style={{ padding: '100px 48px', maxWidth: 1200, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr', gridTemplateRows: '280px 280px', gap: 12 }}>
          ...
          <img src="/studio-1.jpg" alt="Studio" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: 12, filter: 'brightness(0.85)' }} />
          ...
          <img src="/studio-6.jpg" alt="Studio" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: 12, filter: 'brightness(0.85)' }} />
        </div>
      </section>
